...
if __name__ == "__main__":
    ...
    train_ds.save_to_disk("kaggleType/data/kaggle_train")
    val_ds.save_to_disk("kaggleType/data/kaggle_val")
    with open("kaggleType/data/kaggle_labels.json", "w") as f:
        json.dump(list(class_names), f)

    print("✅ Dane zapisane do katalogu 'kaggleType/data/'")
